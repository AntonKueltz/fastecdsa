...
static COMB: OnceLock<Comb<BrainpoolPoint<Brainpoolp224r1>>> = OnceLock::new();
static G_TABLE: OnceLock<Vec<BrainpoolPoint<Brainpoolp224r1>>> = OnceLock::new();
...
impl BrainpoolCurve for Brainpoolp224r1 {
    ...
    fn comb() -> Option<&'static Comb<BrainpoolPoint<Brainpoolp224r1>>> {
        Some(
            COMB.get_or_init(|| {
                Comb::<BrainpoolPoint<Brainpoolp224r1>>::new(Brainpoolp224r1::G_T, 4)
            }),
        )
    }
