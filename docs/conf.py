...
sys.path.insert(0, os.path.abspath('../fastecdsa'))
...
project = u'fastecdsa'
copyright = u'2016, Anton Kueltz'
author = u'Anton Kueltz'
...
latex_documents = [
    (master_doc, 'fastecdsa.tex', u'fastecdsa Documentation',
     u'Anton Kueltz', 'manual'),
]
...
man_pages = [
    (master_doc, 'fastecdsa', u'fastecdsa Documentation',
     [author], 1)
]
