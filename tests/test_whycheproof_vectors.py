...
class TestWycheproofEcdsaVerify(TestCase):
    ...
    def test_brainpoolP384r1_sha384(self):
        filename = "tests/vectors/whycheproof/ecdsa_brainpoolP384r1_sha384_test.json"
        tests = self._get_tests(filename)
    ...
    def test_p224_sha224(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp224r1_sha224_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P224, sha224)

    def test_p224_sha256(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp224r1_sha256_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P224, sha256)

    def test_p224_sha3_224(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp224r1_sha3_224_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P224, sha3_224)

    def test_p224_sha3_256(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp224r1_sha3_256_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P224, sha3_256)

    def test_p224_sha3_512(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp224r1_sha3_512_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P224, sha3_512)

    def test_p224_sha512(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp224r1_sha512_test.json"
        tests = self._get_tests(filename)
    ...
    def test_p256_sha256(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp256r1_sha256_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P256, sha256)

    def test_p256_sha3_256(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp256r1_sha3_256_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P256, sha3_256)

    def test_p256_sha3_512(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp256r1_sha3_512_test.json"
        tests = self._get_tests(filename)
        self._test_runner(tests, P256, sha3_512)

    def test_p256_sha512(self):
        filename = "tests/vectors/whycheproof/ecdsa_secp256r1_sha512_test.json"
        tests = self._get_tests(filename)
