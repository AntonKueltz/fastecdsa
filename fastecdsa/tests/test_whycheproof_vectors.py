...
class TestWycheproofEcdsaVerify(TestCase):
    ...
    def test_brainpool224r1_sha224(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_brainpoolP224r1_sha224_test.json"
        )
    ...
    def test_brainpoolP256r1_sha256(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_brainpoolP256r1_sha256_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_brainpoolP320r1_sha384(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_brainpoolP320r1_sha384_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_brainpoolP384r1_sha384(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_brainpoolP384r1_sha384_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_brainpoolP512r1_sha512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_brainpoolP512r1_sha512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p224_sha224(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp224r1_sha224_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p224_sha256(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp224r1_sha256_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p224_sha3_224(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp224r1_sha3_224_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p224_sha3_256(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp224r1_sha3_256_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p224_sha3_512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp224r1_sha3_512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p224_sha512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp224r1_sha512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_secp256k1_sha256(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256k1_sha256_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_secp256k1_sha3_256(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256k1_sha3_256_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_secp256k1_sha3_512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256k1_sha3_512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_secp256k1_sha512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256k1_sha512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p256_sha3_256(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256r1_sha3_256_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p256_sha3_512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256r1_sha3_512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p256_sha512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp256r1_sha512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p384_sha384(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp384r1_sha384_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p384_sha3_384(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp384r1_sha3_384_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p384_sha3_512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp384r1_sha3_512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p384_sha512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp384r1_sha512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p521_sha3_512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp521r1_sha3_512_test.json"
        )
        tests = self._get_tests(filename)
    ...
    def test_p521_sha512(self):
        filename = (
            "fastecdsa/tests/vectors/whycheproof/ecdsa_secp521r1_sha512_test.json"
        )
        tests = self._get_tests(filename)
